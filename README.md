...
Give Crunchyroll’s simulcast calendar a fitting dark theme like the rest of the site.
You can also search releases by title, filter by audio and subtitle languages, and see availability directly below each episode.
